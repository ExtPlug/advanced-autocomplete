...
import { isArray, extend } from 'underscore'
import Plugin from 'extplug/Plugin'
import SuggestionView from 'plug/views/rooms/chat/ChatSuggestionView'
import ChatView from 'plug/views/rooms/chat/ChatView'

import * as presets from './presets'
import style from './style.css'

const templateItem = window.requirejs('hbs!templates/room/chat/ChatSuggestionItem')
